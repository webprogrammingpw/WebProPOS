...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="." class="brand-link ml-auto mr-auto">
      <img src="{{ url('/assets') }}/dist/img/logo.png" alt="WebPro Logo" class="brand-image img-circle elevation-3" style="opacity: 1">
      <span class="brand-text font-weight-bold">WebPro</span>
    </a>
